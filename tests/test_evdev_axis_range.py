...
def test_z_rz_default_to_stick_range():
  assert default_abs_range(ABS_Z) == (0, 65535, 4096)
  assert default_abs_range(ABS_RZ) == (0, 65535, 4096)
  assert default_abs_range(ABS_GAS) == (0, 1023, 64)
  assert default_abs_range(ABS_Z, prefer_trigger=True) == (0, 1023, 64)


def test_right_stick_rest_centers_with_stick_range():
  # Xbox BLE rest ~ mid of 0..65535; wrong 0..1023 range saturates +32767.
